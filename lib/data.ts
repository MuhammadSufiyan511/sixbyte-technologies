...
export const pricingPlans: PricingPlan[] = [
  {
    ...
    period: 'one-time project budget',
    timeline: '2 - 3 Weeks',
    idealFor: 'Startups, small businesses, clinics, legal practices, restaurants & brand sites',
    description: 'High-converting custom web presence engineered for speed, brand authority, mobile elegance, and search engine visibility.',
    features: [
      'Custom UI/UX Design & Next.js/React Frontend (Up to 6 pages)',
      '100% Mobile Responsive & Ultra-Fast Loading (Core Web Vitals)',
      'Contact Form, WhatsApp Instant Chat & Direct Lead Routing',
      'Services Showcase, About Us, Location & FAQs Section',
      'On-Page SEO, Meta Tags, Google Search Console & Analytics Setup',
      'Domain Registration & VPS/Cloud Hosting Setup Assistance',
      '1 Month Post-Launch Maintenance & Technical Handover',
    ],
    breakdown: [
      { stage: 'Requirements & UI/UX Design', costPKR: 'PKR 25,000', costUSD: '$90' },
      { stage: 'Frontend Development & Responsive UI', costPKR: 'PKR 45,000', costUSD: '$170' },
      { stage: 'SEO, Contact & Lead Integrations', costPKR: 'PKR 25,000', costUSD: '$90' },
      { stage: 'Deployment, SSL Setup & 1-Month Support', costPKR: 'PKR 25,000', costUSD: '$100' },
    ],
    highlighted: false,
  ...
  {
    id: 'web-system',
    name: 'Custom Web App & Digital System',
    price: '$1,100',
    priceUSD: '$1,100',
    ...
    features: [
      'Public Web App & Portal Frontend with Dynamic User Experience',
      'Custom Database Architecture & Real-Time Business Logic Engine',
      'Full Admin Panel (Manage users, content, system schedules, rules & analytics)',
      'Multi-Payment Setup (Online Payment Gateways, Bank Transfers & Manual Billing)',
      'Automated Email Notifications + Admin WhatsApp Instant System Alerts',
      'PostgreSQL / Database, Node.js / Express REST API Server Architecture',
      'Linux VPS Deployment, Nginx Reverse Proxy, SSL Setup & 1-Year Hosting Config',
      'Documentation, 100% Source Code Ownership & 1-Month Post-Launch Support',
    ],
    breakdown: [
      { stage: 'Requirements & UI/UX Design', costPKR: 'PKR 40,000', costUSD: '$150' },
      { stage: 'Customer Website & Portal Frontend', costPKR: 'PKR 60,000', costUSD: '$220' },
      { stage: 'Backend, Database & Core Application Engine', costPKR: 'PKR 80,000', costUSD: '$290' },
      { stage: 'Admin Panel & System Management', costPKR: 'PKR 45,000', costUSD: '$165' },
      { stage: 'Payment & Gateway Integration', costPKR: 'PKR 20,000', costUSD: '$75' },
      { stage: 'Email & WhatsApp Integration', costPKR: 'PKR 15,000', costUSD: '$55' },
      { stage: 'Testing, Deployment, 1-Yr Domain/VPS & Launch', costPKR: 'PKR 40,000', costUSD: '$145' },
      { stage: 'Documentation, Handover & 1-Month Support', costPKR: 'Included', costUSD: 'Included' },
    ],
    highlighted: true,
    cta: 'Get Full Proposal Scope',
  },
  {
    id: 'enterprise',
    name: 'Enterprise Software, AI & Mobile Apps',
    price: '$2,499+',
    priceUSD: '$2,499+',
    pricePKR: 'PKR 750,000+',
    period: 'custom project quote',
    timeline: '8 - 12+ Weeks',
    idealFor: 'Cross-platform mobile apps (iOS/Android), AI products, SaaS platforms, POS & ERP systems',
    description: 'Complex enterprise applications, AI integrations, mobile apps, and scalable multi-tenant cloud software for multi-branch operations.',
    features: [
      'Native / Cross-Platform Mobile Apps (iOS & Android with React Native)',
      'AI Workflows, LLM / Model API Integration & Intelligent Automation',
      'SaaS Multi-Tenant Cloud Architecture with Role-Based Staff Permissions',
      'Retail & Venue POS System with Barcode Checkout & Real-Time Inventory Sync',
      'Automated Billing (Stripe / Subscription Engine), Tax & Financial Reports',
      'Custom REST/GraphQL APIs & 3rd Party ERP/CRM Integrations',
      'High-Availability Cloud Infrastructure, Auto-Backups & Security Audit',
      'Dedicated Project Manager, On-Site/Remote Onboarding & 12 Months Support',
    ],
    breakdown: [
      { stage: 'System Architecture & Specification Design', costPKR: 'PKR 100,000', costUSD: '$350' },
      { stage: 'Cross-Platform Mobile / AI Web Application', costPKR: 'PKR 250,000', costUSD: '$850' },
      { stage: 'Backend REST API, Multi-Tenant DB & AI Engine', costPKR: 'PKR 220,000', costUSD: '$750' },
      { stage: 'Billing, Analytics & Security Setup', costPKR: 'PKR 100,000', costUSD: '$300' },
      { stage: 'Cloud Infra, Deployment & 12-Month Priority SLA', costPKR: 'PKR 80,000', costUSD: '$249+' },
    ],
    highlighted: false,
